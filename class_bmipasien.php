...
<body>
    <div class="container">
        <div class="row mt-5 shadow-sm py-4 px-2 bg-body rounded">
            ...
            <h4 class="text-center txth">Form Isian Indeks Massa Tubuh (BMI)</h4>
              <form method="POST" class="mt-5">
                  ...
                  <button type="submit" class="btn btn-danger txt mt-5 ">Hitung BMI</button>
                </form>
            </div>
            <div class="col-6">
                <?php 
            ...
            <?php  
            if ($_POST){       
                $ns1 = ['No'=>1,'nama'=>'Farhan', 'Umur'=>19,'Jenis Kelamin'=>'Laki-Laki','Berat Badan'=>55,'Tinggi Badan'=>180, 'Hasil BMI'=>50,'Status BMI'=>'Kurang Gizi'];
                $ns2 = ['No'=>2,'nama'=>'Putri', 'Umur'=>35,'Jenis Kelamin'=>'Perempuan','Berat Badan'=>45,'Tinggi Badan'=>166, 'Hasil BMI'=>45,'Status BMI'=>'Kurang'];
                $ns3 = ['No'=>3,'nama'=>'Jamal', 'Umur'=>34,'Jenis Kelamin'=>'Laki-Laki','Berat Badan'=>42,'Tinggi Badan'=>165, 'Hasil BMI'=>50,'Status BMI'=>'Kurang'];
                $ns4 = ['No'=>4,'nama'=>'Joko', 'Umur'=>25,'Jenis Kelamin'=>'Laki-Laki','Berat Badan'=>43,'Tinggi Badan'=>169, 'Hasil BMI'=>50,'Status BMI'=>'Kurang'];
        ...
        <div class="row mt-5 shadow-sm py-3 px-5 bg-body rounded">
            ...
            <table border="1" width="100%" class="table table-striped table-hover btn-danger">
            <thead>
                <tr>
